namespace ABGAlmacenPTL.Modules
{
    ...
    /// Migrado desde VB6 GDConstantes.bas
    /// </summary>
    public static class GDConstantes
    {
        ...
        public static bool Compro { get; set; }
        public static string Driv { get; set; } = string.Empty;
        public static string Nom { get; set; } = string.Empty;
